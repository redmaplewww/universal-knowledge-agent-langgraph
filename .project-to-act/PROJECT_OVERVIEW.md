...
- 当前阶段：`0.2.1` 审批决策单与紧凑知识库已完成
- 当前状态：A-001..A-020/G-007 已通过；本地隔离产品 Gate 完成，但不得宣称外部 IAM、生产容量或领域专家认证
- 最后更新：2026-08-10
...
- 已交付里程碑：本地完整可运行 `0.2.1`；多格式、API、恢复、真实 LLM、文档级 Experience、
...
- 当前知识库已展示 Experience 的背景、问题、机制、行动、结果、依据、关系、边界、原文和演进谱系；
  中断审批会动态展示候选、风险、Scope、逻辑和原文，知识库默认以 5 条紧凑行呈现；下一决策点仍是
