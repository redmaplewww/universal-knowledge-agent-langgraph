...
| 批次聚类索引与跨学科知识图谱 | 已完成 | Codex | F-022 与 A-023/G-010 通过；离线、真实 LLM、图谱检索、AAWO、构建与洁净安装均有新鲜证据 | E-023 | 2026-09-19 |
...
- 2026-09-19｜完成 `0.4.0` F-022｜新增入库领域候选、四桶比例采样、关键知识重采样、聚类级
  ...
  脱敏失败终态；真实 GLM 13/13、AAWO 4/4、65/65、Ruff、编译、wheel/sdist、Python 3.11
