...
Gate 状态库按输出目录隔离且支持小批次重试。2026-09-20 切换到 `deepseek-v4.1-flash` 后，
项目内真实功能 Gate 13/13 通过，报告 SHA-256 为
`5a4825bf2ed820b3ac624bb21bfa731a322d7f17e85d8d16bc5e9f6ee4371c4d`。
...
当前 HTTP Gate 为项目内 Python 标准库脚本，健康、图谱读取、真实 LLM 聚类和跨租户隔离
4/4 通过；报告 SHA-256 为
`b9c9a9496c74a4b82b0d0a4fe3b955eebca492f8fbd9440a8f3df22adf501f40`。旧外部测试工具及其
脚本、Skill、缓存和历史构建产物已经清理，不再作为当前验收依赖。
